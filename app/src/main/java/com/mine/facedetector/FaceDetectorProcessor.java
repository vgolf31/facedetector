...
public class FaceDetectorProcessor extends VisionProcessorBase<List<Face>> {
    ...
    public FaceDetectorProcessor(Context context, OnFaceDetectedListener mFaceDetectedListener) {
        super(context);
    ...
    protected void onSuccess(@NonNull List<Face> faces, @NonNull GraphicOverlay graphicOverlay) throws IOException {
       if(faces.size()==0){
        ...
        for (Face face : faces) {
            graphicOverlay.add(new FaceGraphic(graphicOverlay, face,faceDetectedListener));

...
public class FaceGraphic extends GraphicOverlay.Graphic {
    ...
    FaceGraphic(GraphicOverlay overlay, Face face, OnFaceDetectedListener mFaceDetectedListener) {
        super(overlay);

        this.face = face;
        this.faceDetectedListener = mFaceDetectedListener;
    ...
    public void draw(Canvas canvas) throws IOException {
        Face face = this.face;
        if (face == null) {
            faceDetectedListener.onFaceDetected(false);
            return;
        }
        ...
        // Draw labels
        if(LivePreviewActivity.isPhotoClicked){
            LivePreviewActivity.isPhotoClicked = false;
        }else{
            canvas.drawRect(
  ...
  canvas.drawText(
    ...
    // todo we will remove this

        faceDetectedListener.onFaceDetected(true);

        Log.i("SHUBHAM", "FACEEEEE");
